...
function updateTimer() {
  const targetDate = new Date("february 9, 2025 12:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543865306192'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543816368818'; // Número para el primer botón
